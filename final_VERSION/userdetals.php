...
if(isset($_POST['Submit']))
    ...
    $sq="Select * from account where rollno='".$_SESSION['user']."'";
    ...
    if($val==1)
        {
        $text= $_SESSION['user'].' Your current account balance is '.$row['amount'];
    }
   else if($val==2)
        {
...
<div id="right">
    <form name="query" method="post">
        ...
        <select id="query" name="query" style="border:solid 1px black;">
						...
						<option value="1">MY ACCOUNT BALANCE</option>

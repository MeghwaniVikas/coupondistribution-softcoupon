...
<tr>
<td colspan="4" align="center"><img src="images/ab.png" height="80px" width="240px" alt="form_pic"/></td>
</tr>
<tr align="center">
...
<td colspan="4" align="center"><input type="submit" name="Submit" value="Submit" /><!--<input type="button" value="Check" onclick="validate()"/>--></td>
       ...
       echo '<center><h1>You Are already registered for the Fest. <br/> Your T-shirt will be distributed to your Class rep.</h1></center>';
   ?>
